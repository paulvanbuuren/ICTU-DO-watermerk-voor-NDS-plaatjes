...
$text          = ( empty( $_POST['WATERMERK_body'] ) ) ? 'body' : $_POST['WATERMERK_body'];
$text          = ( ! empty( $_POST['WATERMERK_body'] ) ? $_POST['WATERMERK_body'] : ( ! empty( $_GET['WATERMERK_body'] ) ? $_GET['WATERMERK_body'] : 'Hela, je hebt geen tekst ingevoerd.' ) );
$titel         = ( ! empty( $_POST['WATERMERK_titel'] ) ? $_POST['WATERMERK_titel'] : ( ! empty( $_GET['WATERMERK_titel'] ) ? $_GET['WATERMERK_titel'] : substr( $defaulttitle, 0, WATERMERK_TITLE_LENGTH ) ) );
...
if ( strlen( $text ) > WATERMERK_TXT_LENGTH ) {
    // kan gebeuren
    $factor    = ( WATERMERK_TXT_LENGTH / strlen( $tweettext ) );
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="lead"> <?php echo WATERMERK_READY ?> </p>
                        <a href="<?php echo htmlspecialchars( $destimageurl ) ?>" download="<?php $filename ?>">
                            <img src="<?php echo $destimageurl ?>" alt="Verhofstadt poster"/> </a>
                        <p><a href="index.php"><?php echo WATERMERK_BACK ?></a></p>
                    </div>
                </div>
            </div>
